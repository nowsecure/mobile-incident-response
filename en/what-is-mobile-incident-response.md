...
We will explore these differences in depth in the [Attacking Mobile Devices](mobile-attacks.md) chapter however each of these differences ultimately add up sufficiently to create a paradigm shift from traditional computer-based IR.
